...
-  These projects were developed to strengthen my understanding of mathematical computation, data organization, and logical workflows using Microsoft Excel. The first project focused on calculating and evaluating grades for two courses taken during a semester, while the second project was designed to help a sales retailer track inventory and analyze product profitability.
 ...
 - PROJECT SCREENSHOTS
    ![Grade_Calculator](assets/ExcelAssignment/GradeCalculator.png)
    *Grade calculator for student Courses*  <br>
    ![TechWorld](assets/ExcelAssignment/TechWorld.png)
    *Excel sheet showing devices, their specs,cost and selling price*  <br>
    ![BarChart](assets/ExcelAssignment/TechBarChart.png)
...
#### Mathlab
 ...
 - PROJECT SCREENSHOTS
    ![GraphProject](assets/MathLab/Mathlab1.png)
    *Matrix Calculation to solve Linear Equation*
    ![BusinessBudget](assets/MathLab/Mathlab2.png)
    *ATM Machine Project*
...
#### Personality Quiz
 ...
 - PROJECT SCREENSHOTS
    ![PersonalityCode](assets/PersonalityQuiz/Personalityquiz.png)
    *Calculation for Max Personality*   <br>

    ![Final_Result](assets/PersonalityQuiz/Personalityquiz2.png)
